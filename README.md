...
* [`src/clj/supps/`](src/clj/supps/): Backend and middleware source files (Clojure,
[Compojure](https://github.com/weavejester/compojure))
* [`src/clj/supps/`](src/clj/supps/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/supps/`](src/cljs/supps/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/supps/core.cljs): contains the SPA entry point, `init`
* [`test/cljs/supps/`](test/cljs/supps/): test files (ClojureScript,
...
7. Clone this repo and open a terminal in the `supps` project root directory
...
in the [`src/clj/supps/`](src/clj/supps/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/supps/config.cljs) defaults to `true` in
...
```clj
(ns supps.example
  (:require [supps.config :as config])
...
```sh
port=2000 java -jar target/supps.jar
```
